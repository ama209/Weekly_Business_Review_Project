# Import libraries for file lookups
...
# Import libraries for database querying
import pyodbc
        ...
        IF DB_ID(N'{target_db}') IS NULL
            ...
            BEGIN CATCH
                IF 
                    ...
                    PRINT  'ERROR CREARING {target_db}: ' + ERROR_MESSAGE();
            END CATCH;
        """
...
# Close targetdb cursors and connections. Close sqlalchemy engine
